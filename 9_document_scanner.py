...
#cap = cv2.VideoCapture("documentScanner.mp4")
...
def getWarp(img,biggest):
    ...
    # here is the card's four points [x,y] ,依次 【左上，右上，左下，右下】
    pts2 = np.float32([[0, 0], [widthImg, 0], [0, heightImg], [widthImg, heightImg]])
    matrix = cv2.getPerspectiveTransform(pts1,
                                         pts2)  # here means pts1 ->img transform into pst2 ->size of img 's matrix
